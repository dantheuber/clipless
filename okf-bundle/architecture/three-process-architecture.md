...
- **Renderer** (`src/renderer/`): React 19 app with three entry points (`main.tsx`, `settings-main.tsx`, `tools-launcher-main.tsx`) and matching HTML files. State lives in React Context providers ([Clips Provider](/systems/clips-provider.md), theme, language detection).
