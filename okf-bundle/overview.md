...
Settings (General, Hotkeys and the Tools tab where search terms, tools and templates are made) are a separate window; see the [settings window redesign](decisions/settings-window-redesign.md).
